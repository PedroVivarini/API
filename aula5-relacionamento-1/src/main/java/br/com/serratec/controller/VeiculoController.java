...
public class VeiculoController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", content = {
			...
			@ApiResponse(responseCode = "505", description = "Exceção interna da aplicação") })
							...
							//oq muda da resposta é so o 201 e a mensagem 
//	@Operation(summary = "Cadastra um veiculo", description = "A resposta é o veículos salvo ")
//	@ApiResponses(value = { @ApiResponse(responseCode = "201", content = {
//			@Content(schema = @Schema(implementation = Veiculo.class), mediaType = "application/json") }, description = "Veículo cadastrado"),
//			@ApiResponse(responseCode = "401", description = "Erro de autenticação"),
//			@ApiResponse(responseCode = "403", description = "Não há permissão para acessar o recurso"),
//			@ApiResponse(responseCode = "404", description = "Recurso não encontrado"),
//			@ApiResponse(responseCode = "505", description = "Exceção interna da aplicação") })
